        ...
        <Router>
          ...
          <div className="App">
            <Routes>
              ...
              <Route path="/profile/change-phone-form" element={<ProtectedRoute element={<ChangePhone />} allowedRoles={['ROLE_USER', 'ROLE_ADMIN', 'ROLE_SPECTATOR', 'ROLE_PRESENTER', 'ROLE_PRESIDENT', 'ROLE_MAYOR', 'ROLE_EDITOR']} />} />
